package io.hulk.dubbo.springfox.core.compiler;
 ...
 * from dubbo
 *
 * 修改com.alibaba.dubbo.common.compiler.support.JdkCompiler类，
 * 添加编译参数 -g ，用于打印本地变量表，获取方法参数名字
 */
public class JdkCompiler extends AbstractCompiler {
    ...
    public Class<?> doCompile(String name, String sourceCode) throws Throwable {
        ...
        Boolean result = compiler
            .getTask(null, javaFileManager, diagnosticCollector, options, null, Arrays.asList(javaFileObject)).call();
